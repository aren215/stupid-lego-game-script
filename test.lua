...
if isfolder("arn") == false then
    makefolder("test")
end

if isfolder("arn/sound") == false then
    makefolder("arn/sound")
end

if isfolder("arn/sound/mc") == false then
    makefolder("arn/sound/mc")
end

if isfolder("arn/assets") == false then
    makefolder("arn/assets")
end

if isfolder("arn/config") == false then
    makefolder("arn/config")
end

if isfolder("arn/scripts") == false then
    makefolder("arn/scripts")
end

local sliderapi = {}

local foldername = "arn/config"
local conf = {
...
local function getcustomassetfunc(path)
    if not betterisfile(path) then
        spawn(function()
            ...
            textlabel.Size = UDim2.new(6, 0, 0, 76)
